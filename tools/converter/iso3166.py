...
_records = [
    ...
    Country(u"Falkland Islands", "FK", "FLK", "238",
            u"Falkland Islands"),
    ...
    Country(u"Federated States of Micronesia", "FM", "FSM", "583",
    ...
    Country(u"United States of America", "US", "USA", "840", u"United States of America"),
